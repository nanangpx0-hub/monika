...
class Monitoring extends BaseController
{
    ...
    public function index()
    {
        ...
        // 1. Stats Widgets - Create separate builder instances to avoid clone issues
        // Build base conditions for reuse
        ...
        $data = [
            ...
            // Stats - Create fresh builders for each query
            ...
            'stat_clean' => $baseConditions($this->db->table('dokumen_survei'))->where('status', 'Sudah Entry')->where('pernah_error', 0)->countAllResults(),
