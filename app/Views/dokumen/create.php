                ...
                <form action="/dokumen/store" method="post">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="kode_wilayah" class="form-control" placeholder="Contoh: 3509120001"
                        required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="tanggal_setor" class="form-control" value="<?= date('Y-m-d') ?>"
                        required>
                    </div>
                  </div>
