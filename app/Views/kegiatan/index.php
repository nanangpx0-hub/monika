                ...
                <tbody>
                  <?php foreach ($kegiatan as $k): ?>
                    <tr>
                      ...
                      <td>
                        <form action="<?= base_url('kegiatan/status/' . $k['id_kegiatan']) ?>" method="post"
                          style="display:inline;">
                          <?= csrf_field() ?>
                          <?php if ($k['status'] == 'Aktif'): ?>
                            <input type="hidden" name="status" value="Selesai">
                            <button type="submit" class="btn btn-warning btn-xs"
                              onclick="return confirm('Tutup kegiatan ini?')">
                              <i class="fas fa-stop-circle"></i> Tutup
                            </button>
                          <?php else: ?>
                            <input type="hidden" name="status" value="Aktif">
                            <button type="submit" class="btn btn-success btn-xs"
                              onclick="return confirm('Aktifkan kembali kegiatan ini?')">
                              <i class="fas fa-play-circle"></i> Buka
                            </button>
                          <?php endif; ?>
                        </form>

                        <a href="<?= base_url('kegiatan/delete/' . $k['id_kegiatan']) ?>" class="btn btn-danger btn-sm"
